...
readLess: "Weniger anzeigen",
  ...
  button: "Alle Bewertungen ansehen",
    ...
    contact: {
      ...
      hoursTextLine1: "Mo - Sa: 09:00 - 21:00",
...
readLess: "Show less",
  ...
  button: "View all reviews",
    ...
    contact: {
      ...
      hoursTextLine1: "Mon - Sat: 09:00 - 21:00",
      socialLabel: "Web & Social",
      mapLabel: "Map",
      whatsapp: "WhatsApp",
      telegram: "Telegram",
...
readLess: "Згорнути",
  ...
  button: "Переглянути всі відгуки",
    ...
    contact: {
      ...
      hoursTextLine1: "Пн - Сб: 09:00 - 21:00",
      socialLabel: "Web & Social",
      mapLabel: "Карта",
      whatsapp: "WhatsApp",
      telegram: "Telegram",
...
readLess: string;
  ...
  contact: {
    ...
    hoursLabel: string;
    dummyPhone: string;
    dummyAddressLine1: string;
    dummyAddressLine2: string;
    dummyAddressLine3: string;
    dummyAddressLine4: string;
    dummyAddressLine5: string;
    hoursTextLine1: string;
    socialLabel: string;
    mapLabel: string;
    whatsapp: string;
    telegram: string;
