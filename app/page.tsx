          ...
          <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr] items-start">
            ...
            <div className="space-y-3">
              ...
              <div className="overflow-hidden rounded-2xl border border-gray-200 shadow-sm h-50">
               <iframe
                title="Google Maps"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2760.755947902559!2d8.5419189!3d47.3784507!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479aa0a78383c4fb%3A0x3c33ad066d10cf93!2sKosmetikerin%20Valeriia!5e0!3m2!1sde!2sch!4v1700000000000!5m2!1sde!2sch"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                loading="lazy"
